...
public class TwitterClient extends OAuthBaseClient {
    ...
    public void getTweetSearch(String query, AsyncHttpResponseHandler handler) {
    ...
    public void postRetweet(Boolean isRetweet, long tweetId, AsyncHttpResponseHandler handler) {
        String apiUrl;

        if (isRetweet) {
            apiUrl = "statuses/retweet/" + tweetId + ".json";
        } else {
            apiUrl = "statuses/unretweet/" + tweetId + ".json";
        }
